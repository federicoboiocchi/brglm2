...
knitr::opts_chunk$set(
  ...
  fig.width = 6,
  fig.height = 6,
  knitr::opts_knit$set(root.dir = "~/brglm2/R")
)
```
...
```{r}
mfeat.fou <- read.table("~/multiple+features/mfeat-fou",sep = "")
mfeat.kar <- read.table("~/multiple+features/mfeat-kar",sep = "")
mfeat.pix <- read.table("~/multiple+features/mfeat-pix",sep = "")
```
